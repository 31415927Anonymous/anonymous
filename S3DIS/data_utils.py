...
def load_seg(filelist):
    ...
    return (np.concatenate(points, axis=0),
            ...
            np.concatenate(direction, axis=0),
            np.concatenate(points_extra, axis=0),
            np.concatenate(point_nums_extra, axis=0),
            np.concatenate(labels_seg_extra, axis=0),
            np.concatenate(direction_extra, axis=0))
