...
def dir_augment(direc, xforms):
    direc_xformed_x = tf.matmul(direc[:, :, :3], xforms, name='xdir_xformed')
    direc_xformed_y = tf.matmul(direc[:, :, 3:], xforms, name='ydir_xformed')
    return tf.concat([direc_xformed_x, direc_xformed_y], axis=-1)
